...
shutil.copy(
    os.path.join(src_dir, "favicon.ico"), os.path.join(build_path, "favicon.ico")
)
...
for experience in data["experiences"]:
    for instance in experience["experiences"]:
        ...
        instance["end"] = (
            format_date(instance["end"]) if "end" in instance else "Present"
        )
        instance["skills"] = (
            " · ".join(instance["skills"]).upper() if instance["skills"] else ""
        )
